  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supportService.createContactRequest({
        ...
        email,
        topic: interest,
        message: `So dien thoai/Zalo: ${phone}. Noi dung lien he: ${message || 'Khong co noi dung bo sung.'}`,
            ...
            <div>
              {!isSubmitted ? (
                <form className="cform" onSubmit={handleSubmit}>
                  ...
                  <input id="ct-email" type="email" placeholder="email@example.com" required value={email} onChange={(e) => setEmail(e.target.value)} />
