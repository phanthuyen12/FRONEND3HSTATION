                                ...
                                <div className="details-post-area">
                                    <div className="heading1">
                                        ...
                                        <div className="comment-box">
                                            ...
                                            <div className="space20"></div>
                                            <p className="pera">Đội ngũ H3Station hỗ trợ rất tận tâm từ khâu tư vấn, triển khai đến vận hành. Việc tích hợp giải pháp mới diễn ra trơn tru và nhanh chóng.</p>
                                        </div>
                                        ...
                                        <div className="comment-box comment-box2">
                                            ...
                                            <div className="space20"></div>
                                            <p className="pera">Chúng tôi tìm đến H3Station với bài toán hạ tầng phức tạp và đã nhận được giải pháp tối ưu, đáp ứng đúng nhu cầu. Sự sáng tạo và chuyên môn của họ rất đáng tin cậy.</p>
                                        </div>
