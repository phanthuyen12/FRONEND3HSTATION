...
const Choose1 = () => {
    ...
    const mainContent = {
    subTitle:'Vì sao chọn H3Station?',
    title:'Hạ tầng linh hoạt cho tự động hóa và phát triển sản phẩm',
    Content:'H3Station tập trung vào VPS, n8n và các công cụ giúp bạn thử nghiệm, triển khai và mở rộng sản phẩm nhanh chóng với chi phí hợp lý.',
    btnName:'Tư vấn giải pháp',
    btnUrl:'/contact',
