...
import Nav from './Nav';
export default function Header1({ variant = undefined }) {
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-12">
              <div className="pera">
                <p><img src="/assets/img/icons/header-top-span.png" alt="" /> H3STATION • VPS hiệu năng cao & dịch vụ tự động hóa n8n</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          <div className="cs_main_header_in">
            ...
            <div className="cs_main_header_left">
              <Link className="cs_site_branding d-flex align-items-center" to="/">
                <img
            ...
            <div className="header1-buttons">
                    ...
                    <Link to="/" className="theme-btn1" >Dùng thử n8n miễn phí <span><i className="bi bi-arrow-right"></i>
                    </span></Link>
                    </div>
               </div>
