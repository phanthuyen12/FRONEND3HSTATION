    ...
    return (
        <div>
            <HeroBanner2
                ...
                title="Sẵn sàng tăng tốc vận hành cùng H3STATION"
                featureList={[
            ...
            <About2
                ...
                title="Tăng trưởng với hạ tầng & tự động hóa của H3Station"
                content="H3Station tập trung vào hạ tầng VPS hiệu năng cao, bảo mật và dịch vụ tự động hóa n8n giúp doanh nghiệp vận hành nhanh, giảm chi phí nhân sự và mở rộng linh hoạt."
