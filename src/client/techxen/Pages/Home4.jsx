...
const Home4 = () => {
    return (
        <div>
            <HeroBanner4
                subtitle="Hi, We are H3Station 👋"
                title="H3Station • Cloud & Automation Partner"
                content="Tăng tốc vận hành, tối ưu chi phí với hạ tầng VPS và tự động hóa n8n được thiết kế cho doanh nghiệp."
                btnone="Nhận tư vấn"
                btnoneurl="/landing"
                btntwo="Bắt đầu ngay"
                btntwourl="/landing"
