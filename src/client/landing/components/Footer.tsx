  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(90deg, transparent, rgba(0,186,74,0.3), transparent)' }}
      />

      {/* CTA Banner */}
      <div
        className="relative overflow-hidden"
        style={{ background: 'linear-gradient(135deg, #00BA4A 0%, #00963c 100%)' }}
      >
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8 py-14 flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <a
            ...
            style={{ background: '#ffffff', color: '#00BA4A' }}
          >
            Bắt đầu ngay
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path d="M2 12L12 2M12 2H5M12 2V9" stroke="#00BA4A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </a>
        </div>
        {/* Decorative circles */}
        <div className="absolute right-8 top-1/2 -translate-y-1/2 w-40 h-40 rounded-full bg-white/5 hidden lg:block" />
        <div className="absolute right-24 bottom-0 w-24 h-24 rounded-full bg-white/5 hidden lg:block" />
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-5">
            ...
            <a href="#" className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-full flex items-center justify-center" style={{ background: '#00BA4A' }}>
            ...
            <div className="flex items-center gap-3">
              {socialIcons.map(({ icon, href }) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLAnchorElement).style.background = '#00BA4A';
                    (e.currentTarget as HTMLAnchorElement).style.color = '#fff';
                    (e.currentTarget as HTMLAnchorElement).style.border = '1px solid #00BA4A';
                  }}
                  onMouseLeave={(e) => {
          ...
          <div>
            ...
            <div
              className="flex overflow-hidden rounded-[10px] border transition-all duration-200 focus-within:ring-2 focus-within:ring-[#00BA4A]/30"
            ...
            >
              ...
              <button
                ...
                style={{ background: '#00BA4A', color: '#fff' }}
              >
                Đăng ký
