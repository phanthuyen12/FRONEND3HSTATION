...
const VpsDetailPage = () => {
    ...
    if (loading) {
        return (
            <HostingLayout>
                <div className="min-h-screen bg-gray-50 dark:bg-[#060a09] flex items-center justify-center">
                    <div className="flex flex-col items-center gap-4 opacity-50">
                        <div className="w-12 h-12 border-4 border-[#00BA4A] border-t-transparent rounded-full animate-spin"></div>
                        <p className="text-xs font-black uppercase tracking-widest text-[#00BA4A]">Đang đồng bộ hóa dữ liệu...</p>
                    </div>
                </div>
            </HostingLayout>
        );
    ...
    if (!data) {
        return (
            <HostingLayout>
                <div className="min-h-screen bg-gray-50 dark:bg-[#060a09] py-24 px-4 overflow-x-hidden text-center">
                     <div className="max-w-md mx-auto space-y-8">
                        ...
                        <Link to="/landing-vps-management" className="inline-block bg-[#00BA4A] text-white px-10 py-4 rounded-[10px] font-black uppercase tracking-[2px] transition-all hover:scale-105 active:scale-95 shadow-xl shadow-[#00BA4A]/20">
                            QUAY LẠI DANH SÁCH
                        </Link>
                     </div>
                </div>
            ...
            <div className="bg-gray-50 dark:bg-[#060a09] min-h-screen pb-24 overflow-x-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 py-3">
                    <nav className="flex items-center gap-3 text-[10px] md:text-[11px] font-black uppercase tracking-[2px] transition-all duration-300">
                        ...
                        <FeatherIcon icon="chevron-right" size={10} className="text-gray-300" />
                        <Link to="/landing-vps-management" className="text-gray-400 hover:text-[#00BA4A] transition-colors">Quản lý VPS</Link>
                        <FeatherIcon icon="chevron-right" size={10} className="text-gray-300" />
                        <span className="text-gray-900 dark:text-white uppercase tracking-widest">{data.deviceIp || 'CHI TIẾT'}</span>
                    </nav>
                </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 py-10 relative z-10">
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <h1 className="text-4xl md:text-6xl font-black !text-white uppercase tracking-tighter leading-none">
                                        CHI TIẾT <span className="text-[#00BA4A]">MÁY CHỦ</span>
                                    </h1>
                            ...
                            <div className="flex items-center gap-3 pb-2">
                                <button onClick={() => navigate(-1)} className="p-4 rounded-[10px] bg-white/5 border border-white/10 !text-white/60 hover:!text-white transition-all backdrop-blur-sm">
                                    <FeatherIcon icon="arrow-left" size={20} />
                                </button>
                                <button onClick={() => loadVpsData(id!)} className="p-4 rounded-[10px] bg-white/5 border border-white/10 !text-white/60 hover:text-[#00BA4A] transition-all backdrop-blur-sm">
                ...
                <div className="max-w-7xl mx-auto px-4 py-12">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div className="lg:col-span-2 space-y-8">
                            {/* Control Panel Card */}
                            <div className="bg-white dark:bg-[#0d1412] p-8 rounded-[10px] border border-gray-100 dark:border-white/5 shadow-sm space-y-8">
                                <div className="flex items-center gap-4">
                                    <div className="w-10 h-10 rounded-[10px] bg-[#00BA4A]/10 text-[#00BA4A] flex items-center justify-center">
                                ...
                                <div className="p-4 bg-[#032030]/5 dark:bg-white/5 rounded-[10px] flex items-center gap-3 border border-gray-100 dark:border-white/5">
                                    <FeatherIcon icon="info" size={16} className="text-[#00BA4A]" />
                                    <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest leading-relaxed text-left">
                                        Máy chủ của bạn đang chạy hệ điều hành <span className="text-[#00BA4A]">{data.operatingSystem || 'Windows/Linux'}</span> tối ưu hóa cho n8n Automation.
                                    </p>
                                </div>
                            </div>

                            {/* Detail Specs Card */}
                            <div className="bg-white dark:bg-[#0d1412] p-8 rounded-[10px] border border-gray-100 dark:border-white/5 shadow-sm space-y-6">
                                <div className="flex justify-between items-center pb-6 border-b border-gray-100 dark:border-white/5">
                                    ...
                                    <div className="flex items-center gap-2 px-3 py-1 bg-[#00BA4A]/10 text-[#00BA4A] rounded-lg">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12">
                                    <div className="flex items-center justify-between pb-4 border-b border-gray-50 dark:border-white/5">
                                         <span className="text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">Địa chỉ IPv4</span>
                                         <span className="text-[14px] font-black dark:text-white font-mono">{data.deviceIp || 'Đang cập phát...'}</span>
                                    </div>
                                    <div className="flex items-center justify-between pb-4 border-b border-gray-50 dark:border-white/5">
                                         <span className="text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">Hệ điều hành</span>
                                         <span className="text-[14px] font-black dark:text-white">{data.operatingSystem || 'Linux'}</span>
                                    </div>
                                    <div className="flex items-center justify-between pb-4 border-b border-gray-50 dark:border-white/5">
                                         <span className="text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">vCPU Core(s)</span>
                                         <span className="text-[14px] font-black dark:text-white">{data.cpu || data.cpuInfo || '0'} Core</span>
                                    </div>
                                    <div className="flex items-center justify-between pb-4 border-b border-gray-50 dark:border-white/5">
                                         <span className="text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">Memory RAM</span>
                                         <span className="text-[14px] font-black dark:text-white">{data.ram || (data as any).totalMemory || 0}GB</span>
                                    </div>
                                    <div className="flex items-center justify-between pb-4 border-b border-gray-50 dark:border-white/5">
                                         <span className="text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">SSD Storage</span>
                                         <span className="text-[14px] font-black dark:text-white">{data.storage || (data as any).diskSpace || 0}GB SSD</span>
                                    </div>
                                    <div className="flex items-center justify-between pb-4 border-b border-gray-50 dark:border-white/5">
                                         <span className="text-[12px] font-bold text-gray-500 dark:text-gray-400 uppercase tracking-widest">Network Speed</span>
                                         <span className="text-[14px] font-black text-[#00BA4A]">1 Gbps / Unlimited</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-8">
                            {/* Billing Overview */}
                            <div className="bg-white dark:bg-[#0d1412] p-8 rounded-[10px] border border-gray-100 dark:border-white/5 shadow-sm space-y-6">
                                <h3 className="text-xl font-black dark:text-white uppercase tracking-tighter leading-none border-b border-gray-100 dark:border-white/5 pb-6">Thanh toán</h3>
                                ...
                                <div className="space-y-5">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <span className="text-[14px] font-black text-[#00BA4A]">{fmt(data.billingAmount)}</span>
                                    </div>
                                ...
                                <button 
                                    ...
                                    style={{ backgroundColor: isExpired ? '#EF4444' : '#00BA4A', color: '#FFFFFF' }}
                                >
                            ...
                            <div className="p-8 rounded-[12px] text-white shadow-2xl space-y-6" style={{ backgroundColor: '#000000', color: '#FFFFFF' }}>
                                <div className="flex items-center gap-4">
                                    <div className="w-9 h-9 rounded-xl flex items-center justify-center shadow-lg" style={{ backgroundColor: '#00BA4A' }}>
                                ...
                                <div className="space-y-3">
                                     ...
                                     <div className="text-[11px] font-mono !text-white bg-white/10 p-4 rounded-xl break-all border border-white/5 select-all font-black">
                                ...
                                <div className="pt-6 border-t border-white/10">
                                     <div className="flex items-center gap-3">
                                         <div className="relative flex h-2 w-2">
                                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full opacity-75" style={{ backgroundColor: '#00BA4A' }}></span>
                                            <span className="relative inline-flex rounded-full h-2 w-2" style={{ backgroundColor: '#00BA4A' }}></span>
                                         </div>
                                         <span className="text-[10px] font-black uppercase tracking-[2px]" style={{ color: '#00BA4A' }}>Direct Link Active</span>
                                     </div>
                                </div>
                            </div>
                        </div>
