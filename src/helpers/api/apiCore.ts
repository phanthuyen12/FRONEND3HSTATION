...
axios.interceptors.response.use(
  ...
  (error) => {
    ...
    return Promise.reject(error); // Reject với error object thay vì chỉ message string
  }
);
 ...
 * @param {*} token
 *
 * Backend LabTest dùng chuẩn `Authorization: Bearer <token>`
 */
