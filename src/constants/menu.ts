...
const MENU_ITEMS: MenuItemTypes[] = [
  ...
  {
    key: "apps-landing-pages",
    label: "Landing Pages",
    isTitle: false,
    icon: "mgc_web_line",
    children: [
      {
        key: "landing-pages-list",
        label: "Danh sách Landing Page",
        url: "/admin/landing-pages",
        parentKey: "apps-landing-pages",
      },
      {
        key: "landing-pages-domains",
        label: "Cấu hình tên miền",
        url: "/admin/landing-pages/domains",
        parentKey: "apps-landing-pages",
      },
    ],
  },
