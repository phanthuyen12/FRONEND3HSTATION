...
var FocusGuard = React2.forwardRef(function FocusGuard2(props, ref) {
  ...
  return React2.createElement("span", _extends({}, props, {
    ...
    style: HIDDEN_STYLES,
    onFocus: (event) => {
      if (isSafari2() && isMac() && !isTabFocus(event)) {
        event.persist();
